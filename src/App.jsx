...
import { Search, MapPin, Globe, Mail, Building2, Server, Terminal, Shield, FileText, Loader2 } from 'lucide-react';
...
export default function App() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // alert("Gagal terhubung ke Database."); // Opsional: dimatikan agar tidak mengganggu user biasa
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen font-sans text-slate-800 bg-slate-50">
      {/* Header Sederhana (Tanpa Tombol Login) */}
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          {/* Area kanan header kosong karena fitur admin dihapus */}
        </div>
      </header>
